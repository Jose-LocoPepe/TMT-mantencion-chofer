...
namespace TMTmantencionchofer.Migrations
{
    ...
    [Migration("20241125223758_UpdateSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMT_mantencion_chofer.Models.Bus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMT_mantencion_chofer.Models.Chofer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMT_mantencion_chofer.Models.Tramo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMT_mantencion_chofer.Models.Viaje", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TMT_mantencion_chofer.Models.Viaje", b =>
                {
                    b.HasOne("TMT_mantencion_chofer.Models.Bus", "IdBusNavigation")
                        .WithMany("Viajes")
                        .HasForeignKey("IdBus")
                        .IsRequired()
                        .HasConstraintName("viaje_ibfk_1");

                    b.HasOne("TMT_mantencion_chofer.Models.Chofer", "IdChoferNavigation")
                        .WithMany("Viajes")
                        .HasForeignKey("IdChofer")
                        .IsRequired()
                        .HasConstraintName("viaje_ibfk_2");

                    b.HasOne("TMT_mantencion_chofer.Models.Tramo", "IdTramoNavigation")
                        .WithMany("Viajes")
